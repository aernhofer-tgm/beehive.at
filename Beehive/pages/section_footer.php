<footer class="footer col-md-12 section_footer">
  <hr />
  <div class="col-md-4 col-sm-4 col-xs-6">
    <a href="#"><p class="footer_links">Feedback</p></a>
    <a href="#"><p class="footer_links">Impressum</p></a>
    <a href="#"><p class="footer_links">Dokumentation</p></a>
    <a href="#"><p class="footer_links">FAQ</p></a>
  </div>
